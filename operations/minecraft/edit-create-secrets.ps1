...
<#
.SYNOPSIS
Interactively edits the SOPS-encrypted private settings for the Create server.
...
$SecretRelativePath = 'apps/staging/minecraft-create/minecraft-private.sops.yaml'
$ExpectedSecretName = 'minecraft-create-private'
$ExpectedNamespace = 'minecraft-create'
$ServerLabel = 'Create Mod Minecraft'
